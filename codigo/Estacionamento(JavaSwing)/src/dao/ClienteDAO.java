...
public class ClienteDAO {
    ...
    // Método para gerar um ID sequencial único para novos clientes
    ...
    // Método para salvar um cliente no arquivo de texto
    ...
    // Método para adicionar um veículo a um cliente específico pelo ID
    ...
    // Método para remover um veículo de um cliente específico pelo ID do cliente e placa do veículo
    ...
    // Método para atualizar o arquivo 'clientes.txt' com a lista de clientes atualizada
    ...
    // Método para listar todos os clientes e veículos associados
    ...
    public boolean remover(String id) {
        ...
        if (removed) {
            atualizarArquivo(clientes);
            System.out.println("Cliente removido: " + id); // Log de confirmação
        } else {
            System.out.println("Cliente com ID " + id + " não encontrado para remoção.");
        }
