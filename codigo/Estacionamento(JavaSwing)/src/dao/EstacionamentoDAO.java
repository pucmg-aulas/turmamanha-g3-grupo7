...
public class EstacionamentoDAO {
    ...
    public EstacionamentoDAO() {
        ...
        // Cria o arquivo 'estacionamentos.txt' se ele não existir
    ...
    // Método para gerar um ID sequencial para cada novo estacionamento
    private int gerarId() {
        int ultimoId = 0;
    ...
    // Método para remover estacionamento pelo ID
