...
public class TicketDAO {
    ...
    public boolean registrarSaida(String idVaga, int idEstacionamento) {
        String sql = "UPDATE ticket SET saida = ? WHERE id_vaga = ? AND id_estacionamento = ? AND saida IS NULL";
        ...
        try (Connection connection = BancoDados.getConexao();
            ...
            stmt.setTimestamp(1, java.sql.Timestamp.valueOf(saidaTruncada)); // Salva até os minutos
