...
public class ClienteDAO {
    ...
    public void removerCliente(String clienteId) {
        ...
        if (clienteRemover != null) {
            ...
            atualizarArquivo(clientes); // Atualiza o arquivo com a lista de clientes após a remoção
    ...
    public ClienteModel buscarPorId(String id) {
        ...
        // Método para buscar um cliente por placa
        public ClienteModel buscarClientePorPlaca(String placa) {
            List<ClienteModel> clientes = listarTodos();
            for (ClienteModel cliente : clientes) {
                for (VeiculoModel veiculo : cliente.getVeiculos()) {
                    System.out.println("Verificando placa: " + veiculo.getPlaca() + " para cliente: " + cliente.getNome());
                    if (veiculo.getPlaca().equalsIgnoreCase(placa)) {
                        System.out.println("Cliente encontrado para a placa " + placa + ": " + cliente.getNome());
                        return cliente;
                    }
                }
            }
            System.out.println("Cliente não encontrado para a placa: " + placa);
            return null; // Retorna null se o cliente com a placa específica não for encontrado
        }
